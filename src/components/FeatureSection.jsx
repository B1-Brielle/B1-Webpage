...
const FeatureSection = () => {
  return (
    <section id="feature" className="relative mt-20 border-b border-neutral-800 min-h-[800px]">
      <div className="text-center">
        <span className="bg-neutral-900 text-cyan-500 rounded-full h-6 text-2xl  font-medium px-2 py-1 uppercase">
          Feature
        </span>
